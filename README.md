...
|    指数    | 沪深  | 南方中证500        | 160119 | ¥375                  | ¥371.8               | 1.1%     |
...
|    量化    | 沪深  | -              | -      | -                     | -                    | -        |
| **量化合计** | -   | -              | -      | **-**                 | **-**                | **-**    |
|    行业    | 沪深  | 南方中证全指房地产      | 004643 | -                     | ¥334.01              | -        |
|    行业    | 沪深  | 华夏中证细分食品饮料产业主题 | 013126 | -                     | ¥333                 | -        |
|    行业    | 沪深  | 汇添富中证主要消费      | 000249 | -                     | ¥333                 | -        |
| **行业合计** | -   | -              | -      | **-**                 | **-**                | **-**    |
|    其他    | 美股  | 安硕标普500        | SXR8   | €500                  | €500                 | -        |
|    其他    | 支付宝 | 余额宝            | 余额宝    | 9000                  | 9000                 | -        |
| **其他合计** | -   | -              | -      | **€500**              | **€500**             | **-**    |
|  **总计**  | -   | -              | -      | **¥16,040.91 + €500** | **¥15,996.8 + €500** | -        |
